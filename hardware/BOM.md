...
Prices are approximate (mid-2026, USD) — re-check before ordering.
...
| 4 | Pi 5 DSI display cable (official, or Waveshare Pi5-Display-Cable-200mm) | 1 | $4 | Pi 5 uses 22-pin mini connectors — the generic 15-pin cable does not fit |
...
| 6 | 18650 cells, flat-top unprotected, ≥8 A rated (Samsung 35E / Molicel M35A) | 4 | $28 | X1202 bay fits max 65.3 mm — protected cells are too long; the X1202's own BMS provides protection. Buy from a reputable dealer (18650BatteryStore, IMR), never marketplace no-names |
...
| 13 | 2200 µF 10 V low-ESR electrolytic | 2 | $4 | Reservoir — supplies the 2 A pulse so the 5 V rail doesn't sag |
| 14 | Polyfuse (PTC), 3 A hold | 1 | $1 | Protects the flash branch wiring on a fault |
| 15 | Perfboard 50×70 mm, JST-XH connectors, 20 AWG silicone wire, heat-shrink | — | $12 | |
...
- X1202 mounts on the **bottom**; Camarray HAT sits on top of the 40-pin
  header via stacking header — it only uses I2C + 3V3/5V/GND pins, leaving
